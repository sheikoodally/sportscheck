...
//#endregion
//#region ../../node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/doc.mjs
...
var OPTIONAL_OBJECT$1 = 1;
var createMethodShim$1 = (methodName, getImplementation) => (flags, object, ...arguments_) => {
...
var method_at_default$1 = createMethodShim$1("at", function() {
	if (Array.isArray(this) || typeof this === "string") return stringOrArrayAt$1;
});
var noop$1 = () => {};
var noop_default$1 = noop$1;
...
function mapDoc(doc, cb) {
	...
	function rec(doc2) {
		...
		const result = process2$1(doc2);
		mapped.set(doc2, result);
		return result;
	}
	function process2$1(doc2) {
...
var assertDoc = noop_default$1;
var assertDocArray = noop_default$1;
var assertDocFillParts = noop_default$1;
var assertAlignType = noop_default$1;
...
var trim = { type: DOC_TYPE_TRIM$1 };
var stringReplaceAll$1 = String.prototype.replaceAll ?? function(pattern, replacement) {
	if (pattern.global) return this.replace(pattern, replacement);
	return this.split(pattern).join(replacement);
};
var method_replace_all_default$1 = createMethodShim$1("replaceAll", function() {
	if (typeof this === "string") return stringReplaceAll$1;
});
var OPTION_CR$1 = "cr";
var OPTION_CRLF$1 = "crlf";
var CHARACTER_CR$1 = "\r";
var CHARACTER_CRLF$1 = "\r\n";
var DEFAULT_EOL$1 = "\n";
...
var narrow_emojis_evaluate_default$1 = "©®‼⁉™ℹ↔↕↖↗↘↙↩↪⌨⏏⏱⏲⏸⏹⏺▪▫▶◀◻◼☀☁☂☃☄☎☑☘☝☠☢☣☦☪☮☯☸☹☺♀♂♟♠♣♥♦♨♻♾⚒⚔⚕⚖⚗⚙⚛⚜⚠⚧⚰⚱⛈⛏⛑⛓⛩⛱⛷⛸⛹✂✈✉✌✍✏✒✔✖✝✡✳✴❄❇❣❤➡⤴⤵⬅⬆⬇";
var notAsciiRegex$1 = /[^\x20-\x7F]/u;
var narrowEmojisSet$1 = new Set(narrow_emojis_evaluate_default$1);
...
//#endregion
//#region ../../node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/index.mjs
...
var require_fs = __commonJS({ "node_modules/fast-glob/out/utils/fs.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_glob_parent = __commonJS({ "node_modules/fast-glob/node_modules/glob-parent/index.js"(exports, module) {
	"use strict";
...
var require_utils = __commonJS({ "node_modules/braces/lib/utils.js"(exports) {
	"use strict";
...
var require_stringify = __commonJS({ "node_modules/braces/lib/stringify.js"(exports, module) {
	...
	module.exports = (ast, options8 = {}) => {
		const stringify2 = (node, parent = {}) => {
			const invalidBlock = options8.escapeInvalid && utils$1.isInvalidBrace(parent);
			const invalidNode = node.invalid === true && options8.escapeInvalid === true;
			let output = "";
			if (node.value) {
				if ((invalidBlock || invalidNode) && utils$1.isOpenOrClose(node)) return "\\" + node.value;
				return node.value;
			}
...
var require_expand = __commonJS({ "node_modules/braces/lib/expand.js"(exports, module) {
	...
	var append = (queue = "", stash = "", enclose = false) => {
		...
		if (!queue.length) return enclose ? utils$1.flatten(stash).map((ele) => `{${ele}}`) : stash;
	...
	var expand = (ast, options8 = {}) => {
		...
		const walk = (node, parent = {}) => {
			...
			if (node.nodes && node.ranges > 0) {
				const args = utils$1.reduce(node.nodes);
				if (utils$1.exceedsLimit(...args, options8.step, rangeLimit)) throw new RangeError("expanded array length exceeds range limit. Use options.rangeLimit to increase or disable the limit.");
				let range = fill$1(...args, options8);
				if (range.length === 0) range = stringify2(node, options8);
				q.push(append(q.pop(), range));
				node.nodes = [];
				return;
			}
			const enclose = utils$1.encloseBrace(node);
...
var require_constants = __commonJS({ "node_modules/braces/lib/constants.js"(exports, module) {
	"use strict";
	module.exports = {
		MAX_LENGTH: 1e4,
		CHAR_0: "0",
...
var require_parse = __commonJS({ "node_modules/braces/lib/parse.js"(exports, module) {
	"use strict";
	var stringify2 = require_stringify();
...
var require_constants2 = __commonJS({ "node_modules/micromatch/node_modules/picomatch/lib/constants.js"(exports, module) {
	"use strict";
	var path15 = __require("path");
	var WIN_SLASH = "\\\\/";
...
var require_utils2 = __commonJS({ "node_modules/micromatch/node_modules/picomatch/lib/utils.js"(exports) {
	"use strict";
	var path15 = __require("path");
...
var require_scan = __commonJS({ "node_modules/micromatch/node_modules/picomatch/lib/scan.js"(exports, module) {
	"use strict";
	...
	var scan = (input, options8) => {
		...
		if (opts.unescape === true) {
			...
			if (base && backslashes === true) base = utils$1.removeBackslashes(base);
		}
		const state = {
			prefix,
			input,
...
var require_parse2 = __commonJS({ "node_modules/micromatch/node_modules/picomatch/lib/parse.js"(exports, module) {
	"use strict";
	...
	var parse7 = (input, options8) => {
		...
		const win32 = utils$1.isWindows(options8);
		...
		if (opts.fastpaths !== false && !/(^[*!]|[/()[\]{}"])/.test(input)) {
			...
			state.output = utils$1.wrapOutput(output, state, options8);
			return state;
		}
		while (!eos()) {
			value = advance();
...
var require_picomatch = __commonJS({ "node_modules/micromatch/node_modules/picomatch/lib/picomatch.js"(exports, module) {
	"use strict";
	var path15 = __require("path");
	...
	var picomatch = (glob, options8, returnState = false) => {
		...
		const opts = options8 || {};
		const posix = utils$1.isWindows(options8);
	...
	picomatch.test = (input, regex, options8, { glob, posix } = {}) => {
		...
		const opts = options8 || {};
		const format3 = opts.format || (posix ? utils$1.toPosixSlashes : null);
...
var require_picomatch2 = __commonJS({ "node_modules/micromatch/node_modules/picomatch/index.js"(exports, module) {
	"use strict";
...
var require_micromatch = __commonJS({ "node_modules/micromatch/index.js"(exports, module) {
	...
	micromatch2.matchKeys = (obj, patterns, options8) => {
		if (!utils$1.isObject(obj)) throw new TypeError("Expected the first argument to be an object");
...
var require_stream = __commonJS({ "node_modules/fast-glob/out/utils/stream.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_tasks = __commonJS({ "node_modules/fast-glob/out/managers/tasks.js"(exports) {
	...
	function processPatterns(input, settings) {
		let patterns = input;
		if (settings.braceExpansion) patterns = utils$1.pattern.expandPatternsWithBraceExpansion(patterns);
		if (settings.baseNameMatch) patterns = patterns.map((pattern) => pattern.includes("/") ? pattern : `**/${pattern}`);
		return patterns.map((pattern) => utils$1.pattern.removeDuplicateSlashes(pattern));
	}
...
var require_async = __commonJS({ "node_modules/@nodelib/fs.stat/out/providers/async.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.read = void 0;
...
var require_sync = __commonJS({ "node_modules/@nodelib/fs.stat/out/providers/sync.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.read = void 0;
...
var require_fs2 = __commonJS({ "node_modules/@nodelib/fs.stat/out/adapters/fs.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_settings = __commonJS({ "node_modules/@nodelib/fs.stat/out/settings.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var fs4 = require_fs2();
	var Settings = class {
...
var require_out = __commonJS({ "node_modules/@nodelib/fs.stat/out/index.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_constants3 = __commonJS({ "node_modules/@nodelib/fs.scandir/out/constants.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_async2 = __commonJS({ "node_modules/@nodelib/fs.scandir/out/providers/async.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function makeRplTaskEntry(entry, settings) {
		return (done) => {
			...
			settings.fs.stat(entry.path, (statError, stats) => {
				...
				entry.dirent = utils$1.fs.createDirentFromStats(entry.name, stats);
				done(null, entry);
			});
		};
	}
				...
				return (done) => {
					fsStat.stat(path15, settings.fsStatSettings, (error, stats) => {
						...
						const entry = {
							name,
							path: path15,
							dirent: utils$1.fs.createDirentFromStats(name, stats)
						};
...
var require_sync2 = __commonJS({ "node_modules/@nodelib/fs.scandir/out/providers/sync.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.readdir = exports.readdirWithFileTypes = exports.read = void 0;
	var fsStat = require_out();
...
var require_fs4 = __commonJS({ "node_modules/@nodelib/fs.scandir/out/adapters/fs.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.createFileSystemAdapter = exports.FILE_SYSTEM_ADAPTER = void 0;
	var fs4 = __require("fs");
...
var require_settings2 = __commonJS({ "node_modules/@nodelib/fs.scandir/out/settings.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var path15 = __require("path");
	var fsStat = require_out();
...
var require_out2 = __commonJS({ "node_modules/@nodelib/fs.scandir/out/index.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_common2 = __commonJS({ "node_modules/@nodelib/fs.walk/out/readers/common.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_reader = __commonJS({ "node_modules/@nodelib/fs.walk/out/readers/reader.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_async3 = __commonJS({ "node_modules/@nodelib/fs.walk/out/readers/async.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_async4 = __commonJS({ "node_modules/@nodelib/fs.walk/out/providers/async.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_stream2 = __commonJS({ "node_modules/@nodelib/fs.walk/out/providers/stream.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_sync3 = __commonJS({ "node_modules/@nodelib/fs.walk/out/readers/sync.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var fsScandir = require_out2();
	var common = require_common2();
...
var require_sync4 = __commonJS({ "node_modules/@nodelib/fs.walk/out/providers/sync.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_settings3 = __commonJS({ "node_modules/@nodelib/fs.walk/out/settings.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var path15 = __require("path");
	var fsScandir = require_out2();
...
var require_out3 = __commonJS({ "node_modules/@nodelib/fs.walk/out/index.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_reader2 = __commonJS({ "node_modules/fast-glob/out/readers/reader.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var path15 = __require("path");
	var fsStat = require_out();
...
var require_stream3 = __commonJS({ "node_modules/fast-glob/out/readers/stream.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var stream_1 = __require("stream");
	var fsStat = require_out();
...
var require_async5 = __commonJS({ "node_modules/fast-glob/out/readers/async.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var fsWalk = require_out3();
	var reader_1 = require_reader2();
...
var require_entry = __commonJS({ "node_modules/fast-glob/out/providers/filters/entry.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var utils$1 = require_utils3();
	var EntryFilter = class {
		...
		getFilter(positive, negative) {
			const [absoluteNegative, relativeNegative] = utils$1.pattern.partitionAbsoluteAndRelative(negative);
			const patterns = {
				positive: { all: utils$1.pattern.convertPatternsToRe(positive, this._micromatchOptions) },
				negative: {
					absolute: utils$1.pattern.convertPatternsToRe(absoluteNegative, Object.assign(Object.assign({}, this._micromatchOptions), { dot: true })),
					relative: utils$1.pattern.convertPatternsToRe(relativeNegative, Object.assign(Object.assign({}, this._micromatchOptions), { dot: true }))
				}
			};
		...
		_isMatchToAbsoluteNegative(filepath, patternsRe, isDirectory2) {
			...
			const fullpath = utils$1.path.makeAbsolute(this._settings.cwd, filepath);
			return this._isMatchToPatterns(fullpath, patternsRe, isDirectory2);
		}
		_isMatchToPatterns(filepath, patternsRe, isDirectory2) {
			if (patternsRe.length === 0) return false;
			const isMatched = utils$1.pattern.matchAny(filepath, patternsRe);
			if (!isMatched && isDirectory2) return utils$1.pattern.matchAny(filepath + "/", patternsRe);
			return isMatched;
		}
	};
...
var require_entry2 = __commonJS({ "node_modules/fast-glob/out/providers/transformers/entry.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var utils$1 = require_utils3();
...
var require_async6 = __commonJS({ "node_modules/fast-glob/out/providers/async.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_stream4 = __commonJS({ "node_modules/fast-glob/out/providers/stream.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var stream_1 = __require("stream");
...
var require_sync5 = __commonJS({ "node_modules/fast-glob/out/readers/sync.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var fsStat = require_out();
	var fsWalk = require_out3();
...
var require_sync6 = __commonJS({ "node_modules/fast-glob/out/providers/sync.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_settings4 = __commonJS({ "node_modules/fast-glob/out/settings.js"(exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_out4 = __commonJS({ "node_modules/fast-glob/out/index.js"(exports, module) {
	"use strict";
	...
	(function(FastGlob2) {
		...
		function isDynamicPattern(source2, options8) {
			assertPatternsInput(source2);
			const settings = new settings_1.default(options8);
			return utils$1.pattern.isDynamicPattern(source2, settings);
		}
		FastGlob2.isDynamicPattern = isDynamicPattern;
		function escapePath(source2) {
			assertPatternsInput(source2);
			return utils$1.path.escape(source2);
		}
		FastGlob2.escapePath = escapePath;
		function convertPathToPattern(source2) {
			assertPatternsInput(source2);
			return utils$1.path.convertPathToPattern(source2);
		}
		FastGlob2.convertPathToPattern = convertPathToPattern;
		(function(posix2) {
			function escapePath2(source2) {
				assertPatternsInput(source2);
				return utils$1.path.escapePosixPath(source2);
			}
			posix2.escapePath = escapePath2;
			function convertPathToPattern2(source2) {
				assertPatternsInput(source2);
				return utils$1.path.convertPosixPathToPattern(source2);
			}
		...
		(function(win322) {
			function escapePath2(source2) {
				assertPatternsInput(source2);
				return utils$1.path.escapeWindowsPath(source2);
			}
			win322.escapePath = escapePath2;
			function convertPathToPattern2(source2) {
				assertPatternsInput(source2);
				return utils$1.path.convertWindowsPathToPattern(source2);
			}
...
var require_pseudomap = __commonJS({ "node_modules/pseudomap/pseudomap.js"(exports, module) {
...
var require_map = __commonJS({ "node_modules/pseudomap/map.js"(exports, module) {
...
var require_lru_cache = __commonJS({ "node_modules/editorconfig/node_modules/lru-cache/index.js"(exports, module) {
	"use strict";
...
var require_sigmund = __commonJS({ "node_modules/sigmund/sigmund.js"(exports, module) {
...
var require_fnmatch = __commonJS({ "node_modules/editorconfig/src/lib/fnmatch.js"(exports, module) {
...
var require_ini = __commonJS({ "node_modules/editorconfig/src/lib/ini.js"(exports) {
	"use strict";
...
var require_package = __commonJS({ "node_modules/editorconfig/package.json"(exports, module) {
	module.exports = {
		name: "editorconfig",
		version: "0.15.3",
...
var require_src = __commonJS({ "node_modules/editorconfig/src/index.js"(exports) {
	"use strict";
	var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
		return new (P || (P = Promise))(function(resolve3, reject) {
			function fulfilled(value) {
...
var require_js_tokens = __commonJS({ "node_modules/@babel/code-frame/node_modules/js-tokens/index.js"(exports, module) {
	var Identifier;
	var JSXIdentifier;
	var JSXPunctuator;
	var JSXString;
...
var require_readlines = __commonJS({ "node_modules/n-readlines/readlines.js"(exports, module) {
	"use strict";
	var fs4 = __require("fs");
...
var commonInvalidHandler = (key2, value, utils$1) => {
	const { text, list } = utils$1.normalizeExpectedResult(utils$1.schemas[key2].expected(utils$1));
	const descriptions = [];
	if (text) descriptions.push(getDescription(key2, value, text, utils$1.descriptor));
	if (list) descriptions.push([getDescription(key2, value, list.title, utils$1.descriptor)].concat(list.values.map((valueDescription) => getListDescription(valueDescription, utils$1.loggerPrintWidth))).join("\n"));
	return chooseDescription(descriptions, utils$1.loggerPrintWidth);
};
...
var AliasSchema = class extends Schema {
	...
	expected(utils$1) {
		return utils$1.schemas[this._sourceName].expected(utils$1);
	}
	validate(value, utils$1) {
		return utils$1.schemas[this._sourceName].validate(value, utils$1);
	}
	redirect(_value, _utils) {
...
var ArraySchema = class extends Schema {
	...
	expected(utils$1) {
		const { text, list } = utils$1.normalizeExpectedResult(this._valueSchema.expected(utils$1));
		return {
	...
	validate(value, utils$1) {
		...
		for (const subValue of value) {
			const subValidateResult = utils$1.normalizeValidateResult(this._valueSchema.validate(subValue, utils$1), subValue);
	...
	deprecated(value, utils$1) {
		const deprecatedResult = [];
		for (const subValue of value) {
			const subDeprecatedResult = utils$1.normalizeDeprecatedResult(this._valueSchema.deprecated(subValue, utils$1), subValue);
	...
	forward(value, utils$1) {
		const forwardResult = [];
		for (const subValue of value) {
			const subForwardResult = utils$1.normalizeForwardResult(this._valueSchema.forward(subValue, utils$1), subValue);
			forwardResult.push(...subForwardResult.map(wrapTransferResult));
		}
		return forwardResult;
	}
	redirect(value, utils$1) {
		const remain = [];
		const redirect = [];
		for (const subValue of value) {
			const subRedirectResult = utils$1.normalizeRedirectResult(this._valueSchema.redirect(subValue, utils$1), subValue);
...
var IntegerSchema = class extends NumberSchema {
	...
	validate(value, utils$1) {
		return utils$1.normalizeValidateResult(super.validate(value, utils$1), value) === true && isInt(value);
	}
};
...
var mockable = create_mockable_default({ getPrettierConfigSearchStopDirectory: () => void 0 });
...
var getOffsets = ({ oneBased, oneBasedLine = oneBased, oneBasedColumn = oneBased } = {}) => [oneBasedLine ? 1 : 0, oneBasedColumn ? 1 : 0];
...
var addCodePointToUnexpectedToken = (message) => message.replace(/(?<=^Unexpected token )(?<quote>')?(.)\k<quote>/, (_, _quote, token2) => `"${token2}"(${getCodePoint(token2)})`);
...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-C5C_m5RW.js"));
	try {
...
var { ERR_NETWORK_IMPORT_DISALLOWED, ERR_INVALID_MODULE_SPECIFIER, ERR_INVALID_PACKAGE_CONFIG: ERR_INVALID_PACKAGE_CONFIG2, ERR_INVALID_PACKAGE_TARGET, ERR_MODULE_NOT_FOUND, ERR_PACKAGE_IMPORT_NOT_DEFINED, ERR_PACKAGE_PATH_NOT_EXPORTED, ERR_UNSUPPORTED_DIR_IMPORT, ERR_UNSUPPORTED_RESOLVE_REQUEST } = codes;
...
function requireFromFile(id, parent) {
	return createRequire$1(parent)(id);
}
...
var { breakParent, hardline, indent, join: join3, line: line2, lineSuffix } = builders;
...
function printLeadingComment(path15, options8) {
	...
	if (printer$1.isBlockComment?.(comment)) {
...
function printTrailingComment(path15, options8, previousComment) {
	...
	const isBlock = printer$1.isBlockComment?.(comment);
...
var create_print_pre_check_function_default = () => noop_default;
...
var method_to_reversed_default = createMethodShim("toReversed", function() {
...
var getLanguageByInterpreter = getLanguageByInterpreterNodejs;
...
function optionInfoToSchema(optionInfo, { isCLI, optionInfos, FlagSchema }) {
	...
	if (optionInfo.exception) parameters.validate = (value, schema, utils$1) => optionInfo.exception(value) || schema.validate(value, utils$1);
	else parameters.validate = (value, schema, utils$1) => value === void 0 || schema.validate(value, utils$1);
	...
	if (isCLI && !optionInfo.array) {
		...
		parameters.preprocess = (value, schema, utils$1) => schema.preprocess(originalPreprocess(Array.isArray(value) ? method_at_default(0, value, -1) : value), utils$1);
	}
...
var method_find_last_default = createMethodShim("findLast", function() {
...
var { hardline: hardline2, markAsRoot } = builders;
...
function normalizePrinter(printer$1) {
	if (normalizedPrinters.has(printer$1)) return normalizedPrinters.get(printer$1);
	let { features, getVisitorKeys, embed: originalEmbed, massageAstNode: originalCleanFunction, print: originalPrint, ...printerRestProperties } = printer$1;
	...
	normalizedPrinters.set(printer$1, normalizedPrinter);
	return normalizedPrinter;
}
var PRINTER_FRONT_MATTER_SUPPORT_OFF = Object.fromEntries([
	"clean",
	"embed",
	"print"
...
async function normalizeFormatOptions(options8, opts = {}) {
	...
	rawOptions.getVisitorKeys = printer$1.getVisitorKeys;
...
var { stripTrailingHardline } = utils;
async function printEmbeddedLanguages(path15, genericPrint, options8, printAstToDoc2, embeds) {
	...
	const { printer: printer$1 } = options8;
	const { embed } = printer$1;
	if (!embed) return;
	...
	const { hasPrettierIgnore } = printer$1;
...
function callPluginPrintFunction(path15, options8, printPath, args, embeds) {
	...
	const { printer: printer$1 } = options8;
	let doc2;
	if (printer$1.hasPrettierIgnore?.(path15)) doc2 = print_ignored_default(path15, options8, printPath, args);
	else if (embeds.has(node)) doc2 = embeds.get(node);
	else doc2 = printer$1.print(path15, options8, printPath, args);
	switch (node) {
	...
	if (printer$1.printComment && !printer$1.willPrintOwnComments?.(path15, options8)) doc2 = printComments(path15, doc2, options8);
	return doc2;
}
...
function massageAst(ast, options8) {
	const { printer: printer$1 } = options8;
	const clean2 = printer$1.massageAstNode;
	if (!clean2) return ast;
	const { getVisitorKeys } = printer$1;
...
var method_find_last_index_default = createMethodShim("findLastIndex", function() {
...
var { addAlignmentToDoc, hardline: hardline3 } = builders;
var { printDocToString: printDocToStringWithoutNormalizeOptions } = printer;
var BOM = "﻿";
...
var estreePlugin = createParsersAndPrinters([{
	importPlugin: () => import("./estree-DxkO3Fty.js"),
...
var { parsers, printers } = createParsersAndPrinters([
	{
		importPlugin: () => import("./acorn-BsafIE6l.js"),
		parsers: ["acorn", "espree"]
	},
	{
		importPlugin: () => import("./angular-DJU7W5Lt.js"),
		parsers: [
			"__ng_action",
			"__ng_binding",
			"__ng_interpolation",
	...
	{
		importPlugin: () => import("./babel-DcXWQYnv.js"),
		parsers: [
			"babel",
			"babel-flow",
			"babel-ts",
	...
	{
		importPlugin: () => import("./flow-CtIxmucR.js"),
		parsers: ["flow"]
	},
	{
		importPlugin: () => import("./glimmer-DD148GES.js"),
		parsers: ["glimmer"],
		printers: ["glimmer"]
	},
	{
		importPlugin: () => import("./graphql-D3t9QP8D.js"),
		parsers: ["graphql"],
		printers: ["graphql"]
	},
	{
		importPlugin: () => import("./html-BiTk8Eyp.js"),
		parsers: [
			"html",
			"angular",
			"vue",
	...
	{
		importPlugin: () => import("./markdown-CUURVW0u.js"),
		parsers: [
			"markdown",
			"mdx",
			"remark"
	...
	{
		importPlugin: () => import("./meriyah-BAfMG9hr.js"),
		parsers: ["meriyah"]
	},
	{
		importPlugin: () => import("./postcss-DuwfUmi4.js"),
		parsers: [
			"css",
			"less",
			"scss"
	...
	{
		importPlugin: () => import("./typescript-DKz0U4v3.js"),
		parsers: ["typescript"]
	},
	{
		importPlugin: () => import("./yaml-C5C_m5RW.js"),
		parsers: ["yaml"],
		printers: ["yaml"]
	}
]);
var builtin_plugins_proxy_default = [estreePlugin, {
	options: options7,
	languages,
	parsers,
	printers
...
var slash = path10.sep === "\\" ? (filePath) => method_replace_all_default(0, filePath, "\\", "/") : (filePath) => filePath;
...
var version_evaluate_default = "3.7.4";
var public_exports = {};
...
var inferParser2 = withPlugins((file, options8) => infer_parser_default(options8, { physicalFile: file }));
var sharedWithCli = {
...
//#endregion
export { formatWithCursor2 as a, index_exports as c, resolveConfigFile as d, sharedWithCli as f, format2 as i, public_exports as l, doc_exports as m, clearCache3 as n, getSupportInfo2 as o, version_evaluate_default as p, debugApis as r, get_file_info_default as s, check as t, resolveConfig as u };