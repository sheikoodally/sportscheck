//#region ../../node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/plugins/angular.mjs
var Hs = Object.defineProperty;
var rn = (e) => {
	throw TypeError(e);
};
var an = (e, t) => {
	for (var n in t) Hs(e, n, {
		get: t[n],
		enumerable: !0
	});
};
var ft = (e, t, n) => t.has(e) || rn("Cannot " + n);
var U = (e, t, n) => (ft(e, t, "read from private field"), n ? n.call(e) : t.get(e)), ze = (e, t, n) => t.has(e) ? rn("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), dt = (e, t, n, s) => (ft(e, t, "write to private field"), s ? s.call(e, n) : t.set(e, n), n), x = (e, t, n) => (ft(e, t, "access private method"), n);
var Fs = {};
an(Fs, { parsers: () => tn });
var tn = {};
an(tn, {
	...
	__ng_binding: () => Xr,
	__ng_directive: () => Yr,
	__ng_interpolation: () => Jr
});
function on({ start: e, end: t }, n) {
	let s = e, r = t;
...
function un(e, t, n) {
	...
	throw new Error(`Cannot find front char ${t} from index ${n} in ${JSON.stringify(e)}`);
}
function hn(e, t, n) {
	let s = cn(t);
	...
	throw new Error(`Cannot find character ${t} from index ${n} in ${JSON.stringify(e)}`);
}
function pn(e) {
...
function js(e, t, n) {
	...
	for (let r = 0; r < s; r++) if (!n(e[r], t[r])) return !1;
	return !0;
}
function at(e, t) {
	return js(e, t, (n, s) => n.isEquivalent(s));
}
var _ = class {
	type;
	sourceSpan;
...
var vt = class e extends _ {
	...
	isEquivalent(t) {
		return t instanceof e && this.fn.isEquivalent(t.fn) && at(this.args, t.args) && this.pure === t.pure;
	}
	isConstant() {
		return !1;
	}
	...
	clone() {
		return new e(this.fn.clone(), this.args.map((t) => t.clone()), this.type, this.sourceSpan, this.pure);
	}
};
var xt = class e extends _ {
	...
	isEquivalent(t) {
		return t instanceof e && this.classExpr.isEquivalent(t.classExpr) && at(this.args, t.args);
	}
	isConstant() {
		return !1;
	}
	...
	clone() {
		return new e(this.classExpr.clone(), this.args.map((t) => t.clone()), this.type, this.sourceSpan);
	}
}, wt = class e extends _ {
	body;
	flags;
	constructor(t, n, s) {
...
var Et = class e extends _ {
	...
	isEquivalent(t) {
		return t instanceof e && this.condition.isEquivalent(t.condition) && this.trueCase.isEquivalent(t.trueCase) && qs(this.falseCase, t.falseCase);
	}
	isConstant() {
		return !1;
	}
...
var w = class e extends _ {
	...
	isEquivalent(t) {
		return t instanceof e && at(this.entries, t.entries);
	}
	visitExpression(t, n) {
		return t.visitLiteralArrayExpr(this, n);
	}
	clone() {
		return new e(this.entries.map((t) => t.clone()), this.type, this.sourceSpan);
	}
};
var kt = class e extends _ {
	entries;
	valueType = null;
	constructor(t, n, s) {
	...
	clone() {
		return new e(this.entries.map((n) => n.clone()), this.type, this.sourceSpan);
	}
};
var Qe;
(function(e) {
...
var Re = class extends Pe {
	...
	static createMinus(t, n, s) {
		return new e(t, n, "-", s, "-", new k(t, n, 0), s);
	}
	static createPlus(t, n, s) {
		return new e(t, n, "+", s, "-", s, new k(t, n, 0));
	}
	constructor(t, n, s, r, i, o, c) {
...
var ye = 0;
var as = 9, Xe = 10, Gs = 11, Xs = 12, Js = 13, os = 32, Ys = 33, ls = 34, Qs = 35, Ht = 36, Ks = 37, In = 38, cs = 39, Ae = 40, q = 41, Nn = 42, us = 43, re = 44, hs = 45, ke = 46, Ke = 47, j = 58, Te = 59, Zs = 60, b = 61, er = 62, Pn = 63, tr = 48;
var nr = 57, Ut = 65, sr = 69;
var Wt = 90, le = 91, mt = 92, G = 93, rr = 94, ot = 95, ps = 97;
var ir = 101, ar = 102, or = 110, lr = 114, cr = 116, ur = 117, hr = 118;
var fs = 122, Ze = 123, Ln = 124, ie = 125, ds = 160;
var Pt = 96;
function pr(e) {
	return e >= as && e <= os || e == ds;
}
function W(e) {
	return tr <= e && e <= nr;
}
function Lt(e) {
	return e >= ps && e <= fs || e >= Ut && e <= Wt;
}
function Mn(e) {
	return e === cs || e === ls || e === Pt;
}
var et = class e {
	file;
	offset;
...
var fr = "(:(where|is)\\()?", ms = "-shadowcsshost", dr = "-shadowcsscontext", Rt = "[^)(]*", qt = `(?:\\((${`(?:\\(${`(?:\\(${Rt}\\)|${Rt})+?`}\\)|${Rt})+?`})\\))`;
new RegExp("(:nth-[-\\w]+)" + qt, "g");
new RegExp(ms + qt + "?([^,{]*)", "gim");
var vr = dr + qt + "?([^{]*)";
new RegExp(`${fr}(${vr})`, "gim");
...
var kr = [
	...
	toString() {
		switch (this.type) {
			...
			case p.Error:
			case p.RegExpBody:
			case p.RegExpFlags: return this.strValue;
			case p.Number: return this.numValue.toString();
			default: return null;
		}
	}
}, Ie = class extends I {
...
function _e(e, t, n) {
	return new I(e, t, p.Character, n, String.fromCharCode(n));
}
function Tr(e, t, n) {
	return new I(e, t, p.Identifier, 0, n);
}
function br(e, t, n) {
	return new I(e, t, p.PrivateIdentifier, 0, n);
}
function Ar(e, t, n) {
	return new I(e, t, p.Keyword, 0, n);
}
function Ce(e, t, n) {
	return new I(e, t, p.Operator, 0, n);
}
function Ir(e, t, n) {
	return new I(e, t, p.Number, n, "");
}
function Nr(e, t, n) {
	return new I(e, t, p.Error, 0, n);
}
function Pr(e, t, n) {
	return new I(e, t, p.RegExpBody, 0, n);
}
function Lr(e, t, n) {
	return new I(e, t, p.RegExpFlags, 0, n);
}
var Ge = new I(-1, -1, p.Character, 0, ""), Dt = class {
	input;
	tokens = [];
	length;
	peek = 0;
	...
	scanToken() {
		...
		let i = r;
		switch (s) {
			case ke: return this.advance(), W(this.peek) ? this.scanNumber(i) : _e(i, this.index, ke);
			case Ae:
			case q:
			case le:
			case G:
			...
			case Ze: return this.scanOpenBrace(i, s);
			case ie: return this.scanCloseBrace(i, s);
			case cs:
			case ls: return this.scanString();
			case Pt: return this.advance(), this.scanTemplateLiteralPart(i);
			case Qs: return this.scanPrivateIdentifier();
			case us: return this.scanComplexOperator(i, "+", b, "=");
			case hs: return this.scanComplexOperator(i, "-", b, "=");
			case Ke: return this.isStartOfRegex() ? this.scanRegex(r) : this.scanComplexOperator(i, "/", b, "=");
			case Ks: return this.scanComplexOperator(i, "%", b, "=");
			case rr: return this.scanOperator(i, "^");
			case Nn: return this.scanStar(i);
			case Pn: return this.scanQuestion(i);
			case Zs:
			case er: return this.scanComplexOperator(i, String.fromCharCode(s), b, "=");
			case Ys:
			case b: return this.scanComplexOperator(i, String.fromCharCode(s), b, "=", b, "=");
			case In: return this.scanComplexOperator(i, "&", In, "&", b, "=");
			case Ln: return this.scanComplexOperator(i, "|", Ln, "|", b, "=");
			case ds:
...
function Zn(e) {
	return ps <= e && e <= fs || Ut <= e && e <= Wt || e == ot || e == Ht;
}
function es(e) {
	return Lt(e) || W(e) || e == ot || e == Ht;
}
function Mr(e) {
	return e == ir || e == sr;
}
...
var we = class {
	...
	parseAction(t, n, s) {
		...
		let { stripped: i } = this._stripComments(t);
		return new F(new z(t, n, s, this._lexer.tokenize(i), 1, r, 0, this._supportsDirectPipeReferences).parseChain(), t, O(n), s, r);
	}
	parseBinding(t, n, s) {
		let r = [];
		return new F(this._parseBindingAst(t, n, s, r), t, O(n), s, r);
	}
	...
	_parseBindingAst(t, n, s, r) {
		this._checkNoInterpolation(r, t, n);
		let { stripped: i } = this._stripComments(t);
		return new z(t, n, s, this._lexer.tokenize(i), 0, r, 0, this._supportsDirectPipeReferences).parseChain();
	}
	parseTemplateBindings(t, n, s, r, i) {
		return new z(n, s, i, this._lexer.tokenize(n), 0, [], 0, this._supportsDirectPipeReferences).parseTemplateBindings({
			source: t,
			span: new B(r, r + t.length)
		});
	}
	...
	parseInterpolationExpression(t, n, s) {
		let { stripped: r } = this._stripComments(t), i = this._lexer.tokenize(r), o = [], c = new z(t, n, s, i, 0, o, 0, this._supportsDirectPipeReferences).parseChain();
		return this.createInterpolationAst(["", ""], [c], t, O(n), s, o);
	}
	createInterpolationAst(t, n, s, r, i, o) {
		let c = new Y(0, s.length);
		return new F(new Vt(c, c.toAbsolute(i), t, n), s, r, i, o);
	}
	splitInterpolation(t, n, s, r) {
		let i = [], o = [], c = [], h = r ? Br(r) : null, d = 0, g = !1, S = !1, E = "{{", P = "}}";
		for (; d < t.length;) if (g) {
			let C = d, N = C + 2, H = this._getInterpolationEndIndex(t, P, N);
			if (H === -1) {
				g = !1, S = !0;
				break;
			}
			let nn = H + 2, sn = t.substring(N, H);
			sn.trim().length === 0 && s.push(oe("Blank expressions are not allowed in interpolated strings", t, `at column ${d} in`, n)), o.push({
				text: sn,
				start: C,
				end: nn
			});
...
var ts = new Set([
	...
	parsePrefix() {
		if (this.next.type == p.Operator) {
			...
			switch (n) {
				case "+": return this.advance(), s = this.parsePrefix(), J.createPlus(this.span(t), this.sourceSpan(t), s);
				case "-": return this.advance(), s = this.parsePrefix(), J.createMinus(this.span(t), this.sourceSpan(t), s);
				case "!": return this.advance(), s = this.parsePrefix(), new K(this.span(t), this.sourceSpan(t), s);
			}
	...
	parseLiteralMap() {
		...
		if (this.expectCharacter(Ze), !this.consumeOptionalCharacter(ie)) {
			...
			do {
				let r = this.inputIndex, i = this.next.isString(), o = this.expectIdentifierOrKeywordOrString(), c = {
					key: o,
					quoted: i
				};
	...
	getDirectiveBoundTarget() {
		...
		let t = this.parsePipe(), { start: n, end: s } = t.span;
		return new F(t, this.input.substring(n, s), O(this.parseSourceSpan), this.absoluteOffset + n, this.errors);
	}
	parseAsBinding(t) {
		...
		this.consumeStatementTerminator();
		return new ge(new B(t.span.start, this.currentAbsoluteOffset), n, t);
	}
	parseLetBinding() {
		...
		return new ge(new B(t, this.currentAbsoluteOffset), n, s);
	}
...
function oe(e, t, n, s) {
	n.length > 0 && (n = ` ${n} `);
	let r = O(s);
	return new Mt(s, `Parser Error: ${e}${n}[${t}] in ${r}`);
}
...
Array.from(Or).reduce((e, [t, n]) => (e.set(t, n), e), /* @__PURE__ */ new Map());
new we(new Ue());
function D(e) {
	return (t) => t.kind === e;
}
function Ne(e, t) {
	return (n) => n.kind === e && t === n.expression instanceof rt;
}
D(f.StyleMap), D(f.ClassMap), D(f.StyleProp), D(f.ClassProp), Ne(f.Attribute, !0), Ne(f.Property, !0), Ne(f.Attribute, !1);
Ne(f.DomProperty, !0), Ne(f.DomProperty, !1), D(f.Attribute), D(f.StyleMap), D(f.ClassMap), D(f.StyleProp), D(f.ClassProp);
new Set([
	f.Listener,
	f.TwoWayListener,
	f.AnimationListener,
...
new Map([
	[L.HTML, l.sanitizeHtml],
	[L.RESOURCE_URL, l.sanitizeResourceUrl],
	[L.SCRIPT, l.sanitizeScript],
	[L.STYLE, l.sanitizeStyle],
	[L.URL, l.sanitizeUrl],
	[L.ATTRIBUTE_NO_BINDING, l.validateAttribute]
]);
new Map([[L.HTML, l.trustConstantHtml], [L.RESOURCE_URL, l.trustConstantResourceUrl]]);
var ns;
(function(e) {
...
new At("21.0.2");
function qe(e = "test.html") {
	let t = new et(new tt("", e), 0, 0, 0);
	return new nt(t, t);
}
var Hr = (e) => we.prototype._commentStart(e);
function Ur(e, t) {
	let n = t ? Hr(e) : null;
	if (n === null) return {
		text: e,
...
function je(e, t = !0) {
	return (n) => {
		let s = new we(new Ue()), { text: r, comments: i } = Ur(n, t), o = e(r, s);
...
var Ss = je((e, t) => t.parseBinding(e, qe(), 0));
je((e, t) => t.parseSimpleBinding(e, qe(), 0));
var Es = je((e, t) => t.parseAction(e, qe(), 0)), ys = je((e, t) => t.parseInterpolationExpression(e, qe(), 0)), _s = je((e, t) => t.parseTemplateBindings("", e, qe(), 0, 0), !1);
var Cs = (e, t) => (n, s, ...r) => n | 1 && s == null ? void 0 : (t.call(s) ?? s[e]).apply(s, r);
function qr(e) {
	return this[e < 0 ? this.length + e : e];
}
var lt = Cs("at", function() {
...
var ks = class {
	...
	getCharacterIndex(e, t) {
		return hn(this.text, e, t);
	}
	getCharacterLastIndex(e, t) {
		return un(this.text, e, t);
	}
	transformSpan(e, { stripSpaces: t = !1, hasParentParens: n = !1 } = {}) {
		if (!t) return Ee(e);
		let { outerSpan: s, innerSpan: r, hasParens: i } = ln(e, this.text, n), o = Ee(r);
		return i && (o.extra = {
			parenthesized: !0,
			parenStart: s.start,
			parenEnd: s.end
	...
	createNode(e, { stripSpaces: t = !0, hasParentParens: n = !1 } = {}) {
		let { type: s, start: r, end: i } = e, o = {
			...e,
			...this.transformSpan({
				start: r,
				end: i
...
function te(e) {
	return ct(e) ? e.extra.parenStart : e.start;
}
function ne(e) {
	return ct(e) ? e.extra.parenEnd : e.end;
}
function zt(e) {
	return e.type === "TSNonNullExpression" && !ct(e) ? zt(e.expression) : (e.type === "OptionalCallExpression" || e.type === "OptionalMemberExpression") && !ct(e);
}
function Ts(e, t) {
	let { start: n, end: s } = e.sourceSpan;
...
var Gt = class extends ks {
	...
	#e(e, { stripSpaces: t = !0, hasParentParens: n = !1 } = {}) {
		return this.createNode(e, {
			stripSpaces: t,
			hasParentParens: n
		});
	}
	#i(e, t, { computed: n, optional: s, hasParentParens: r = !1 }) {
		let { receiver: i } = e;
		if (Ts(i, this.#n) || i.sourceSpan.start === t.start) return t;
		let o = this.#t(i), c = zt(o);
		return this.#e({
			type: s || c ? "OptionalMemberExpression" : "MemberExpression",
			object: o,
			property: t,
			computed: n,
			...s ? { optional: !0 } : c ? { optional: !1 } : void 0,
			...e.sourceSpan
		}, { hasParentParens: r });
	}
	#t(e, t) {
	...
	#s(e, t) {
		...
		if (e instanceof J) return this.#e({
			type: "UnaryExpression",
			prefix: !0,
			argument: this.#t(e.expr),
			operator: e.operator,
			...e.sourceSpan
		}, { hasParentParens: n });
		if (e instanceof y) {
			let { left: s, operation: r, right: i } = e, o = this.#t(s), c = this.#t(i), h = {
				left: o,
				right: c,
				start: te(o),
				end: ne(c)
			...
			return r === "&&" || r === "||" || r === "??" ? this.#e({
				...
				operator: r
			}, { hasParentParens: n }) : y.isAssignmentOperation(r) ? this.#e({
				...h,
				type: "AssignmentExpression",
				left: o,
				operator: r,
				...e.sourceSpan
			}, { hasParentParens: n }) : this.#e({
				...h,
		...
		if (e instanceof Re) {
			let { exp: s, name: r, args: i } = e, o = this.#t(s), c = te(o), h = ne(o), d = this.getCharacterIndex(/\S/, this.getCharacterIndex("|", h) + 1), g = this.#e({
				type: "Identifier",
				name: r,
				start: d,
				end: d + r.length
			...
			return this.#e({
				...
				arguments: S,
				start: c,
				end: ne(S.length === 0 ? g : lt(0, S, -1))
			}, { hasParentParens: n });
		}
		if (e instanceof Le) return this.#e({
			type: "NGChainedExpression",
			expressions: e.expressions.map((s) => this.#t(s)),
			...e.sourceSpan
		}, { hasParentParens: n });
		if (e instanceof Me) {
			let { condition: s, trueExp: r, falseExp: i } = e, o = this.#t(s), c = this.#t(r), h = this.#t(i);
			return this.#e({
		...
		if (e instanceof A) return this.#e({
			type: "NGEmptyExpression",
			...e.sourceSpan
		}, { hasParentParens: n });
		if (e instanceof Q) return this.#e({
			type: "ThisExpression",
			...e.sourceSpan
		}, { hasParentParens: n });
		if (e instanceof $e) return this.#e({
			type: "ArrayExpression",
			elements: e.expressions.map((s) => this.#t(s)),
			...e.sourceSpan
		}, { hasParentParens: n });
		if (e instanceof De) {
			let { keys: s, values: r } = e, i = r.map((c) => this.#t(c)), o = s.map(({ key: c, quoted: h }, d) => {
				let g = i[d], S = te(g), E = ne(g), P = this.getCharacterIndex(/\S/, d === 0 ? e.sourceSpan.start + 1 : this.getCharacterIndex(",", ne(i[d - 1])) + 1), C = {
					start: P,
					end: S === P ? E : this.getCharacterLastIndex(/\S/, this.getCharacterLastIndex(":", S - 1) - 1) + 1
				}, N = h ? this.#e({
					type: "StringLiteral",
					value: c,
					...C
		...
		if (e instanceof k) {
			let { value: s } = e;
			switch (typeof s) {
				case "boolean": return this.#e({
					type: "BooleanLiteral",
					value: s,
					...e.sourceSpan
				}, { hasParentParens: n });
				case "number": return this.#e({
					type: "NumericLiteral",
					value: s,
					...e.sourceSpan
				}, { hasParentParens: n });
				case "object": return this.#e({
					type: "NullLiteral",
					...e.sourceSpan
				}, { hasParentParens: n });
				case "string": return this.#e({
					type: "StringLiteral",
					value: s,
					...e.sourceSpan
				}, { hasParentParens: n });
				case "undefined": return this.#e({
					type: "Identifier",
					name: "undefined",
					...e.sourceSpan
				}, { hasParentParens: n });
				default: throw new Error(`Unexpected LiteralPrimitive value type ${typeof s}`);
			}
		}
		if (e instanceof Ve) return this.#e({
			type: "RegExpLiteral",
			pattern: e.body,
			flags: e.flags ?? "",
			...e.sourceSpan
		}, { hasParentParens: n });
		if (e instanceof Oe || e instanceof pe) {
			let s = e instanceof pe, { receiver: r, args: i } = e, o = i.length === 1 ? [this.#t(i[0], { isInParentParens: !0 })] : i.map((g) => this.#t(g)), c = this.#t(r), h = zt(c), d = s || h ? "OptionalCallExpression" : "CallExpression";
			return this.#e({
				type: d,
				callee: c,
				arguments: o,
				...d === "OptionalCallExpression" ? { optional: s } : void 0,
				start: te(c),
				end: e.sourceSpan.end
			}, { hasParentParens: n });
		}
		if (e instanceof Be) {
			let s = this.#t(e.expression);
			return this.#e({
		...
		if (e instanceof K || e instanceof Z || e instanceof ee) {
			let s = e instanceof K ? "!" : e instanceof Z ? "typeof" : e instanceof ee ? "void" : void 0;
			if (!s) throw new Error("Unexpected expression.");
			let { start: r } = e.sourceSpan;
			if (s === "typeof" || s === "void") {
				let o = this.text.lastIndexOf(s, r);
				if (o === -1) throw new Error(`Cannot find operator '${s}' from index ${r} in ${JSON.stringify(this.text)}`);
				r = o;
			}
			let i = this.#t(e.expression);
			return this.#e({
				type: "UnaryExpression",
				prefix: !0,
				operator: s,
		...
		if (e instanceof ue || e instanceof he) return this.#i(e, this.#t(e.key), {
			computed: !0,
			optional: e instanceof he,
			hasParentParens: n
		});
		if (e instanceof X || e instanceof ce) {
			let { receiver: s, name: r } = e, i = this.#e({
				type: "Identifier",
				name: r,
				...e.nameSpan
			}, Ts(s, this.#n) ? { hasParentParens: n } : {});
			return this.#i(e, i, {
				computed: !1,
				optional: e instanceof ce,
				hasParentParens: n
			});
		}
		if (e instanceof fe) return this.#e({
			type: "TaggedTemplateExpression",
			tag: this.#t(e.tag),
			quasi: this.#t(e.template),
			...e.sourceSpan
		});
		if (e instanceof de) {
			let { elements: s, expressions: r } = e;
			return this.#e({
				type: "TemplateLiteral",
				quasis: s.map((i) => this.#t(i, { parent: e })),
				expressions: r.map((i) => this.#t(i)),
				...e.sourceSpan
			});
		}
		if (e instanceof me) {
			let { elements: s } = t.parent, r = s.indexOf(e), i = r === 0, o = r === s.length - 1, c = e.sourceSpan.end - (o ? 1 : 0), h = e.sourceSpan.start + (i ? 1 : 0), d = this.text.slice(h, c);
			return this.#e({
		...
		if (e instanceof Fe) return this.#s(e.expression);
		throw new Error(`Unexpected node type '${e.constructor.name}'`);
	}
};
function bs(e, t) {
	return new Gt(e, t).node;
}
function As(e) {
...
var Se, se, m, Ps, T, Xt, Jt, Yt, Ls, Ms, Rs, $s, Ns, zr = (Ns = class extends Gt {
	constructor(t, n) {
		super(void 0, n);
		ze(this, m);
		ze(this, Se);
	...
	return x(this, m, T).call(this, {
		type: "NGMicrosyntax",
		body: r,
		...r.length === 0 ? t[0].sourceSpan : {
			start: r[0].start,
			end: lt(0, r, -1).end
		}
	});
	...
	if (As(t)) {
		let { key: s, value: r } = t;
		return r ? n === 0 ? x(this, m, T).call(this, {
			type: "NGMicrosyntaxExpression",
			expression: x(this, m, Xt).call(this, r.ast),
			alias: null,
			...r.sourceSpan
		}) : x(this, m, T).call(this, {
			type: "NGMicrosyntaxKeyedExpression",
			key: x(this, m, T).call(this, {
				type: "NGMicrosyntaxKey",
				name: x(this, m, Jt).call(this, s.source),
				...s.span
			}),
			expression: x(this, m, T).call(this, {
				type: "NGMicrosyntaxExpression",
				expression: x(this, m, Xt).call(this, r.ast),
				alias: null,
				...r.sourceSpan
		...
		if (/^let\s$/.test(U(this, se).slice(r.start, r.start + 4))) {
			...
			return x(this, m, T).call(this, {
				...
				value: i ? x(this, m, T).call(this, {
					type: "NGMicrosyntaxKey",
					name: i.source,
					...i.span
				}) : null,
				start: r.start,
				end: i ? i.span.end : s.span.end
			});
		} else {
...
function Ds(e, t) {
	return new zr(e, t).expressions;
}
function ut({ result: { ast: e }, text: t, comments: n }) {
	return Object.assign(bs(e, t), { comments: n });
}
function Bs({ result: { templateBindings: e }, text: t }) {
	return Ds(e, t);
}
var Qt = (e) => ut(Ss(e));
var Kt = (e) => ut(ys(e)), ht = (e) => ut(Es(e)), Zt = (e) => Bs(_s(e));
function en(e) {
...
function pt(e) {
	return {
		astFormat: "estree",
		parse(t) {
			let n = e(t), { comments: s } = n;
			return delete n.comments, e === ht && n.type !== "NGChainedExpression" && (n = {
				...n,
				type: "NGChainedExpression",
				expressions: [n]
			}), {
...
var Gr = pt(ht), Xr = pt(Qt), Jr = pt(Kt), Yr = pt(Zt);

//#endregion
export { tn as n, Fs as t };