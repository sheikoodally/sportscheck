//#region ../../node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/plugins/babel.mjs
...
Re(kt, {
	...
	__js_expression: () => Gr,
	__ts_expression: () => Xr,
	__vue_event_binding: () => Wr,
	__vue_expression: () => Gr,
	__vue_ts_event_binding: () => Jr,
	__vue_ts_expression: () => Xr,
	babel: () => Wr,
	"babel-flow": () => qs,
	"babel-ts": () => Jr
});
...
var Dt = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED", Js = {
...
}, be = (a) => a.type === "UpdateExpression" ? Mt.UpdateExpression[`${a.prefix}`] : Mt[a.type], Gs = {
...
function ti({ toMessage: a, code: t, reasonCode: e, syntaxPlugin: s }) {
	...
	return function r(n, o) {
		...
		}), Ot(h, "details", o), Object.defineProperty(h, "message", {
			configurable: !0,
			get() {
...
var { defineProperty: ri } = Object, Ft = (a, t) => {
	a && ri(a, t, {
		enumerable: !1,
		value: a[t]
	});
...
}, T = !0, m = !0, Ue = !0, oe = !0, j = !0, ni = !0, we = class {
	label;
	keyword;
	beforeExpr;
	startsExpr;
...
var pe = -1, dt = [], mt = [], yt = [], xt = [], Pt = [], gt = [];
function P(a, t = {}) {
	return ++pe, mt.push(a), yt.push(t.binop ?? -1), xt.push(t.beforeExpr ?? !1), Pt.push(t.startsExpr ?? !1), gt.push(t.prefix ?? !1), dt.push(new we(a, t)), pe;
}
function b(a, t = {}) {
	return ++pe, ft.set(a, pe), mt.push(a), yt.push(t.binop ?? -1), xt.push(t.beforeExpr ?? !1), Pt.push(t.startsExpr ?? !1), gt.push(t.prefix ?? !1), dt.push(new we("name", t)), pe;
}
var oi = {
	bracketL: P("[", {
		beforeExpr: T,
	...
	_for: S("for", { isLoop: Ue }),
	_while: S("while", { isLoop: Ue }),
...
var bt = "ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙՠ-ֈא-תׯ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࡠ-ࡪࡰ-ࢇࢉ-࢏ࢠ-ࣉऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱৼਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚ౜ౝౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽ೜-ೞೠೡೱೲഄ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄຆ-ຊຌ-ຣລວ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜑᜟ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡸᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭌᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲊᲐ-ᲺᲽ-Ჿᳩ-ᳬᳮ-ᳳᳵᳶᳺᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄯㄱ-ㆎㆠ-ㆿㇰ-ㇿ㐀-䶿一-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-Ƛ꟱-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꣾꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭩꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ", Xt = "·̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߽߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛ࢗ-࢟࣊-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯৾ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ૺ-૿ଁ-ଃ଼ା-ୄେୈୋ-୍୕-ୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఄ఼ా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ೳഀ-ഃ഻഼ാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ඁ-ඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ຼ່-໎໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜕ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠏-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᪿ-᫝᫠-᫫ᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭᳴᳷-᳹᷀-᷿‌‍‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯・꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧ꠬ꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱ꣿ-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿･", Pi = /* @__PURE__ */ new RegExp("[" + bt + "]"), gi = /* @__PURE__ */ new RegExp("[" + bt + Xt + "]");
bt = Xt = null;
var Yt = [
	0,
	11,
...
function B(a) {
	return a < 65 ? a === 36 : a <= 90 ? !0 : a < 97 ? a === 95 : a <= 122 ? !0 : a <= 65535 ? a >= 170 && Pi.test(String.fromCharCode(a)) : Ke(a, Yt);
}
function K(a) {
	return a < 48 ? a === 36 : a < 58 ? !0 : a < 65 ? !1 : a <= 90 ? !0 : a < 97 ? a === 95 : a <= 122 ? !0 : a <= 65535 ? a >= 170 && gi.test(String.fromCharCode(a)) : Ke(a, Yt) || Ke(a, Ti);
}
var At = {
	keyword: [
		"break",
...
var Di = /\*?\s*@((?:no)?flow)\b/, Mi = (a) => class extends a {
	flowPragma = void 0;
	getScopeHandler() {
		return We;
	}
	...
	flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
		...
		for (s && this.match(6) ? (this.expect(6), l = 9, u = !0) : (this.expect(5), l = 8, u = !1), h.exact = u; !this.match(l);) {
			...
			if (this.eat(0)) A != null && this.unexpected(A), this.eat(0) ? (C && this.unexpected(C.loc.start), h.internalSlots.push(this.flowParseObjectTypeInternalSlot(N, x))) : h.indexers.push(this.flowParseObjectTypeIndexer(N, x, C));
				...
				let I = "init";
				if (this.isContextual(99) || this.isContextual(104)) Jt(this.lookahead().type) && (I = this.state.value, this.next());
...
`);
		...
		case 120: {
			let l;
			return {code: l, pos: t} = et(a, t, e, s, 2, !1, n, r), o(l === null ? null : String.fromCharCode(l));
		}
		case 117: {
			let l;
			return {code: l, pos: t} = rs(a, t, e, s, n, r), o(l === null ? null : String.fromCodePoint(l));
		}
		case 116: return o("	");
		case 98: return o("\b");
		case 118: return o("\v");
...
function et(a, t, e, s, i, r, n, o) {
	let h = t, l;
	return {n: l, pos: t} = is(a, t, e, s, 16, i, r, !1, o, !n), l === null && (n ? o.invalidEscapeSequence(h, e, s) : t = h - 1), {
		code: l,
		pos: t
	};
}
function is(a, t, e, s, i, r, n, o, h, l) {
	let u = t, f = i === 16 ? _t.hex : _t.decBinOct, d = i === 16 ? Te.hex : i === 10 ? Te.dec : i === 8 ? Te.oct : Te.bin, x = !1, A = 0;
	for (let k = 0, N = r ?? Infinity; k < N; ++k) {
		...
		if (C >= 97 ? I = C - 97 + 10 : C >= 65 ? I = C - 65 + 10 : Ui(C) ? I = C - 48 : I = Infinity, I >= i) {
			if (I <= 9 && l) return {
				n: null,
				pos: t
			};
...
function rs(a, t, e, s, i, r) {
	let n = a.charCodeAt(t), o;
	if (n === 123) {
		if (++t, {code: o, pos: t} = et(a, t, e, s, a.indexOf("}", t) - t, !0, i, r), ++t, o !== null && o > 1114111) if (i) r.invalidCodePoint(t, e, s);
		else return {
			code: null,
			pos: t
		};
		...
		e: for (; this.state.pos < this.length;) {
			...
			switch (s) {
				...
				case 47:
					...
					break;
				default: if (Fi(s)) ++this.state.pos;
...
}, ht = (a) => a.type === "ParenthesizedExpression" ? ht(a.expression) : a, ct = class extends ot {
	toAssignable(t, e = !1) {
		let s;
...
function lt(a) {
	...
	switch (a.type) {
		...
		case "MemberExpression": return !a.computed && lt(a.object);
		case "TSInstantiationExpression": return lt(a.expression);
		default: return !1;
	}
}
...
function Gi(a) {
	...
	return t && e.type !== "StringLiteral" && (e.type !== "TemplateLiteral" || e.expressions.length > 0) ? !1 : os(a.object);
}
function Xi(a, t) {
	let { type: e } = a;
	if (a.extra?.parenthesized) return !1;
	...
	return !!(ns(a, t) || Yi(a, t) || e === "TemplateLiteral" && a.expressions.length === 0 || Gi(a));
}
function ns(a, t) {
...
function Yi(a, t) {
	if (a.type === "UnaryExpression") {
		...
		if (e === "-" && ns(s, t)) return !0;
	}
	return !1;
}
function os(a) {
	return a.type === "Identifier" ? !0 : a.type !== "MemberExpression" || a.computed ? !1 : os(a.object);
}
var $t = F`placeholders`({
	ClassNameIsRequired: "A class name is required.",
	UnexpectedSpace: "Unexpected space in placeholder."
}), Qi = (a) => class extends a {
	parsePlaceholder(e) {
		if (this.match(133)) {
			let s = this.startNode();
...
var hs = {
	...
	v8intrinsic: Zi,
	placeholders: Qi
}, tr = Object.keys(hs), pt = class extends ct {
	checkProto(t, e, s, i) {
...
function ar(a) {
	let t = {};
	for (let e of Object.keys(a)) t[e] = Gt(a[e]);
	return t;
}
ar(oi);
function le(a, t) {
...
function nr(a) {
	let t = [];
	for (let i of tr) a.has(i) && t.push(i);
...
var fs = hr;
function cr(a, t) {
	return t === !1 ? !1 : a.charAt(t) === "/" && a.charAt(t + 1) === "/" ? ls(a, t) : t;
}
var ds = cr;
function lr(a, t) {
	let e = null, s = t;
	for (; s !== e;) e = s, s = cs(a, s), s = ps(a, s), s = ds(a, s), s = fs(a, s);
	return s;
}
var ms = lr;
function ys(a) {
...
var ur = Array.prototype.findLast ?? function(a) {
	for (let t = this.length - 1; t >= 0; t--) {
		let e = this[t];
		if (a(e, t, this)) return e;
	}
}, xs = ee("findLast", function() {
	if (Array.isArray(this)) return ur;
});
function dr(a) {
	return this[a < 0 ? this.length + a : a];
}
var Ps = ee("at", function() {
...
function gr(a) {
	return St.has(a) || St.set(a, se(a) && a.value[0] === "*" && /@(?:type|satisfies)\b/u.test(a.value)), St.get(a);
}
var Ts = gr;
function Tr(a) {
	if (!se(a)) return !1;
...
function br(a) {
	return wt.has(a) || wt.set(a, Tr(a)), wt.get(a);
}
var Ct = br;
function Ar(a) {
	...
	for (let e = a.length - 1; e >= 0; e--) {
		let s = a[e];
		if (t && L(s) === M(t) && Ct(s) && Ct(t) && (a.splice(e + 1, 1), s.value += "*//*" + t.value, s.range = [M(s), L(t)]), !gs(s) && !se(s)) throw new TypeError(`Unknown comment type: "${s.type}".`);
		t = s;
	}
}
var bs = Ar;
...
var wr = 10;
for (let a = 0; a <= wr; a++) ye();
function Et(a) {
	return ye(a);
}
function Cr(a, t = "type") {
	Et(a);
	function e(s) {
		let i = s[t], r = a[i];
			...
			switch (h.type) {
				case "ParenthesizedExpression": {
					...
					if (!r) {
						if (!o) {
							o = [];
							for (let x of i) Ts(x) && o.push(L(x));
						}
						let d = xs(0, o, (x) => x <= u);
...
function kr(a) {
	...
	let o = ` (${i}:${r})`;
	return t.endsWith(o) && (t = t.slice(0, -o.length)), t.startsWith(ks) && (t = t.slice(ks.length)), De(t, {
		loc: { start: {
			line: i,
			column: r + 1
		} },
...
var Me = kr;
var vr = String.prototype.replaceAll ?? function(a, t) {
...
function Ms(a) {
	a = xe(0, a.replace(Mr, "").replace(Dr, ""), Rr, "$1");
	let e = "";
	for (; e !== a;) e = a, a = xe(0, a, Br, `
$1 $2
`);
	a = a.replace(vs, "").trimEnd();
	let s = Object.create(null), i = xe(0, a, Ls, "").replace(vs, "").trimEnd(), r;
	for (; r = Ls.exec(a);) {
		let n = xe(0, r[2], Fr, "");
...
var Os = ["noformat", "noprettier"], Fs = ["format", "prettier"];
function Bs(a) {
	let t = ve(a);
	t && (a = a.slice(t.length + 1));
	let { pragmas: s, comments: i } = Ms(Ds(a));
	return {
		shebang: t,
		text: a,
		pragmas: s,
...
function _s(a) {
	if (typeof a == "string") {
		...
		if (/\.(?:cjs|cts)$/iu.test(a)) return Nt;
	}
}
function jr(a, t) {
...
var ie = (a) => H(Kr(a)), Vr = {
	...
	tokens: !1,
	ranges: !1
}, js = "v8intrinsic", Vs = [["pipelineOperator", {
	proposal: "hack",
	topicToken: "%"
}], ["pipelineOperator", { proposal: "fsharp" }]], _ = (a, t = Vr) => ({
	...t,
	plugins: [...t.plugins, ...a]
}), zr = /@(?:no)?flow\b/u;
function qr(a, t) {
	...
	let s = ms(a, 0);
	return s !== !1 && (a = a.slice(0, s)), zr.test(a);
}
function $r(a, t, e) {
	let s = a(t, e), i = s.errors.find((r) => !Hr.has(r.reasonCode));
	if (i) throw i;
	return s;
}
function Kr({ isExpression: a = !1, optionsCombinations: t }) {
	return (e, s = {}) => {
		let { filepath: i } = s;
		if (typeof i != "string" && (i = void 0), (s.parser === "babel" || s.parser === "__babel_estree") && qr(e, i)) return s.parser = "babel-flow", qs.parse(e, s);
...
]), zs = [_(["jsx"])], Wr = ie({ optionsCombinations: zs }), Jr = ie({ optionsCombinations: [_(["jsx", "typescript"]), _(["typescript"])] }), Gr = ie({
	isExpression: !0,
	optionsCombinations: [_(["jsx"])]
}), Xr = ie({
	isExpression: !0,
	optionsCombinations: [_(["typescript"])]
}), qs = ie({ optionsCombinations: [_([
	"jsx",
	["flow", { all: !0 }],
	"flowComments"
])] }), Yr = ie({ optionsCombinations: zs.map((a) => _(["estree"], a)) });
var Lt = {};
Re(Lt, {
	json: () => ea,
	"json-stringify": () => ia,
...
function Be(a, t = {}) {
	...
	if (!e && vt(i.comments)) throw q(i.comments[0], "Comment");
	return i = Fe(i, {
		type: "JsonRoot",
		text: a
...
function re(a) {
	switch (a.type) {
		...
		case "Identifier":
			...
			return;
		case "TemplateLiteral":
			if (vt(a.expressions)) throw q(a.expressions[0], "'TemplateLiteral' with expression");
...
var ea = H({
	...
	hasPragma: () => !0,
	hasIgnorePragma: () => !1
}), ta = H((a) => Be(a)), sa = H((a) => Be(a, { allowEmpty: !0 })), ia = H({
