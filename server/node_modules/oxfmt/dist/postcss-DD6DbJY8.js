//#region ../../node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/plugins/postcss.mjs
...
var Te = (t, e, s) => (s = t != null ? bl(kl(t)) : {}, Al(e || !t || !t.__esModule ? Vr(s, "default", {
	value: t,
	enumerable: !0
}) : s, t));
var Oi = w((ux, os) => {
...
var nl = w((rb, sl) => {
	...
	sl.exports = class {
		constructor(e, s) {
			this.cache = [], this.input = e, this.options = Object.assign({}, { loose: !1 }, s), this.position = 0, this.unbalanced = 0, this.root = new yy();
			let n = new gy();
...
var bt = (t, e) => (s, r, ...n) => s | 1 && r == null ? void 0 : (e.call(r) ?? r[t]).apply(r, n);
var Ol = String.prototype.replaceAll ?? function(t, e) {
...
var G = bt("at", function() {
	if (Array.isArray(this) || typeof this == "string") return Nl;
});
var Rl = () => {}, K = Rl;
var je = "string", He = "array", Et = "cursor", ie = "indent", Ae = "align", St = "trim", oe = "group", ae = "fill", me = "if-break", kt = "indent-if-break", Oe = "line-suffix", Tt = "line-suffix-boundary", X = "line", At = "label", Ce = "break-parent", Ot = new Set([
	Et,
	ie,
	Ae,
	St,
...
var ue = Il;
var ql = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function Ll(t) {
...
var Pt = Symbol.for("PRETTIER_IS_FRONT_MATTER");
function Hl(t) {
	return !!t?.[Pt];
}
var Re = Hl;
...
var P = (t) => t.source?.startOffset, R = (t) => t.source?.endOffset;
var nc = /\*\/$/, ic = /^\/\*\*?/, Nn = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/, oc = /(^|\s+)\/\/([^\n\r]*)/g, An = /^(\r?\n)+/, ac = /(?:^|\r?\n) *(@[^\n\r]*?) *\r?\n *(?![^\n\r@]*\/\/[^]*)([^\s@][^\n\r@]+?) *\r?\n/g, On = /(?:^|\r?\n) *@(\S+) *([^\n\r]*)/g, uc = /(\r?\n|^) *\* ?/g, Pn = [];
function Rn(t) {
	let e = t.match(Nn);
...
var Dn = ["noformat", "noprettier"], Mn = ["format", "prettier"], Bn = "format";
function lc(t) {
...
var Gn = (t) => Fn(ge(t).content), Yn = (t) => $n(ge(t).content), Vn = (t) => {
...
var yi = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu, wc = new RegExp(yi.source + `|(${/[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu.source})?(${/(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu.source})(${/[a-z]+/giu.source})?`, "giu");
function V(t, e) {
...
var dl = Te(ht(), 1), ml = Te(qo(), 1), yl = Te(da(), 1);
function gp(t, e) {
...
var hl = Wy;
var Gy = /(\s*)(!default).*$/u, Yy = /(\s*)(!global).*$/u;
function gl(t, e) {
	if (Se(t)) {
		delete t.parent;
...
//#endregion
export { en as a, _l as i, Si as n, Ti as r, Hy as t };